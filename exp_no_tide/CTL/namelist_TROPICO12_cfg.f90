...
&namrun        !   parameters of the run
!-----------------------------------------------------------------------
   cn_exp      =  'TROPICO12_NST-TRPC12N00'  !  experience name
   nn_it000    =    48241   !  first time step
   nn_itend    =    52704   !  last  time step (std 5840)
   ...
   ln_rstart   =  .true.   !  start from rest (F) or from a restart file (T)
      ...
      cn_ocerst_in    = 'TROPICO12_NST-TRPC12N00_00048240_restart_oce'   !  suffix of ocean restart name (input)
      cn_ocerst_indir = '/scratch/cnt0024/hmg2840/lbrodeau/NEMO/TROPICO12/TROPICO12_NST-TRPC12N00-R/00048240'         !  directory from which to read input ocean restarts
      cn_ocerst_out   = 'restart_oce'   !  suffix of ocean restart name (output)
      cn_ocerst_outdir = '/scratch/cnt0024/hmg2840/lbrodeau/NEMO/TROPICO12/TROPICO12_NST-TRPC12N00-R/00052704'         !  directory in which to write output ocean restarts
   nn_istate   =       0   !  output the initial state (1) or not (0)
   ln_rst_list = .false.   !  output restarts at list of times using nn_stocklist (T) or at set frequency with nn_stock (F)
   nn_stock    = 2160  ! 1year @ 5400 s  frequency of creation of a restart file (modulo referenced to 1)
...
!-----------------------------------------------------------------------
   ...
   !           !  file name              ! frequency (hours) ! variable  ! time interp.!  clim  ! 'yearly'/ !       weights filename               ! rotation ! land/sea mask !
   !           !                         !  (if <0  months)  !   name    !   (logical) !  (T/F) ! 'monthly' !                                      ! pairing  !    filename   !
   sn_wndi =  'u10_ERA5_tropico-box_surface_1h', 1., 'u10',     .true.   , .false. , 'yearly'  , 'weight_bicubic_ERA5_tropico-box_1071x361-TROPICO12.nc'  , 'Uwnd'   , ''
   sn_wndj =  'v10_ERA5_tropico-box_surface_1h', 1., 'v10',     .true.   , .false. , 'yearly'  , 'weight_bicubic_ERA5_tropico-box_1071x361-TROPICO12.nc'  , 'Vwnd'   , ''
   sn_qsr  = 'ssrd_ERA5_tropico-box_surface_1h', 1.,'ssrd',     .false.  , .false. , 'yearly'  , 'weight_bilinear_ERA5_tropico-box_1071x361-TROPICO12.nc' , ''       , ''
   sn_qlw  = 'strd_ERA5_tropico-box_surface_1h', 1.,'strd',     .false.  , .false. , 'yearly'  , 'weight_bilinear_ERA5_tropico-box_1071x361-TROPICO12.nc' , ''       , ''
   sn_tair =  't2m_ERA5_tropico-box_surface_1h', 1., 't2m',     .true.   , .false. , 'yearly'  , 'weight_bilinear_ERA5_tropico-box_1071x361-TROPICO12.nc' , ''       , ''
   sn_humi =  'd2m_ERA5_tropico-box_surface_1h', 1., 'd2m',     .true.   , .false. , 'yearly'  , 'weight_bilinear_ERA5_tropico-box_1071x361-TROPICO12.nc' , ''       , ''
   sn_prec =   'tp_ERA5_tropico-box_surface_1h', 1.,  'tp',     .false.  , .false. , 'yearly'  , 'weight_bilinear_ERA5_tropico-box_1071x361-TROPICO12.nc' , ''       , ''
   sn_snow =   'tp_ERA5_tropico-box_surface_1h', 1.,  'tp',     .false.  , .false. , 'yearly'  , 'weight_bilinear_ERA5_tropico-box_1071x361-TROPICO12.nc' , ''       , ''
   sn_slp  =  'msl_ERA5_tropico-box_surface_1h', 1., 'msl',     .true.   , .false. , 'yearly'  , 'weight_bilinear_ERA5_tropico-box_1071x361-TROPICO12.nc' , ''       , ''
/
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
   ...
   sn_apr  =  'msl_ERA5_tropico-box_surface_1h', 1., 'msl',     .true.   , .false. , 'yearly'  , 'weight_bilinear_ERA5_tropico-box_1071x361-TROPICO12.nc' , ''       , ''
/
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
   ...
   nn_dyn2d_dta   =  1,1,1,1,1        !  = 0, bdy data are equal to the initial state
